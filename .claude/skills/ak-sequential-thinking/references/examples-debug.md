...
```
Record 1: Initial investigation
...
Record 3: Profiling results (adjusted up—more complex)
...
Record 4 [BRANCH A]: Hypothesis - N+1 query
...
Record 4 [BRANCH B]: Hypothesis - Missing index
...
Record 5 [VERIFICATION]: Testing hypotheses
...
Record 6 [FINAL]: Solution and verification
