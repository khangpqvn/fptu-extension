...
**Typically precedes:** `/ak:plan` (understand architecture before planning)
**Related:** `/ak:scout` (quick file search), `/ak:repomix` (full context dump), `/ak:gkg` (semantic symbol navigation)
